...
#load data
data = pickle.load(file(DATA_DIR))
...
x_test = x_test + 1
print 'x_test size: ',x_test.size#14600*200=2801200
...
print 'y_test_sample: ',y_test[0,0]
...
for i in xrange(len(x_test)):
    ...
    if i in idx:
        ...
        print('x_test_d shape: ',x_test_d.shape)#(1,200)
        print 'x_test_d: ',x_test_d#200

        for j in xrange(len(idx_Row)):
            print 'binary_func_start j',binary_func_start[j]#86
            print 'idx_Row j',idx_Row[j]#0
